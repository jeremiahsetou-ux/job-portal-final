...
const SKILLS_ARTICLES = [
  { id: '7', headline: 'Digital Skills in High Demand 2026', date: '2026-04-03', author: 'JobHelper Team', excerpt: 'Which digital skills are South African employers looking for this year.', imageUrl: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=600&h=400&fit=crop' },
  { id: '8', headline: 'Building Your Professional Network', date: '2026-03-29', author: 'JobHelper Team', excerpt: 'How to effectively build and leverage professional connections in South Africa.', imageUrl: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=400&fit=crop' },
];

export function generateStaticParams() {
  return [{ slug: 'career-advice' }];
}
        ...
        <section className="py-16 bg-gradient-to-r from-purple-600 to-indigo-700">
          <div className="container mx-auto px-4 text-center text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/tools/cv-builder" className="bg-white text-purple-700 px-6 py-3 rounded-lg font-medium hover:bg-gray-100">
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/tools/cv-builder" className="text-primary font-medium hover:underline">View All</Link>
            </div>
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/learn" className="text-primary font-medium hover:underline">View All</Link>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {SKILLS_ARTICLES.map((news) => (
                <NewsCard key={news.id} {...news} />
              ))}
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-card border rounded-xl p-6 text-center">
                ...
                <Link href="/tools/cv-builder" className="text-primary font-medium hover:underline">Get Started</Link>
              </div>
              <div className="bg-card border rounded-xl p-6 text-center">
