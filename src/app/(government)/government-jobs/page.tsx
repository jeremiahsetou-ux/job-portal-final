...
const GOVERNMENT_JOBS = [
  ...
  { id: '5', title: 'Finance Officer', company: 'Dept of Health', location: 'Bloemfontein', category: 'Government', postedAt: '4 days ago', remote: false },
  { id: '6', title: 'IT Support Specialist', company: 'Dept of Transport', location: 'Pretoria', category: 'Government', postedAt: '5 days ago', remote: false },
];
          ...
          <div className="container mx-auto px-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-8">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/tools/z83-form" className="bg-primary text-primary-foreground px-6 py-3 rounded-lg font-medium hover:bg-primary/90">
                  Fill Z83 Form Online
                </Link>
                <Link href="/tools/z83-form#download" className="border border-primary text-primary px-6 py-3 rounded-lg font-medium hover:bg-primary/10">
                  Download Blank Form
                </Link>
              </div>
            </div>
